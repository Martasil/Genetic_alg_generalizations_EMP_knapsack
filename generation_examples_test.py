...
source_file = open("EMP_8x8_2_8_1.txt", "r")
...
vecinos[nodo_esquina1 - 1].append(nodo_esquina1 + 8)
vecinos[nodo_esquina1 - 1].append(nodo_esquina1 - 1)
...
vecinos[nodo_esquina2 - 1].append(nodo_esquina2 + 8)
...
vecinos[nodo_esquina3 - 1].append(nodo_esquina3 - 8)
...
vecinos[nodo_esquina4 - 1].append(nodo_esquina4 - 8)
...
for pos_columna_clockwise in range(1,7):
...
for pos_fila_clockwise in range(2,8):
...
nodos_dentro = []
for pos_columna in range(2,8):
  nodos_dentro.append(size4 + size + pos_columna)
  nodos_dentro.append(size4 + size2 + pos_columna)
  nodos_dentro.append(size4 + size3 + pos_columna)
  nodos_dentro.append(size4 + size4 + pos_columna)
  nodos_dentro.append(size4 + size4 + size + pos_columna)
  nodos_dentro.append(size4 + size4 + size2 + pos_columna)
